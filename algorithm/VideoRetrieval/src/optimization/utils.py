...
def setup_e2e_optimizer(model, opts):
    ...
    all_grouped_parameters = build_e2e_optimizer_w_lr_mul(
        all_param_optimizer,
        opts.learning_rate, opts.tp_learning_rate, opts.weight_decay,
        lr_mul=opts.lr_mul,
...
def build_e2e_optimizer_w_lr_mul(
        model_param_optimizer, learning_rate, tp_learning_rate, weight_decay,
    ...
    decay_clip_param_tp = [(n, p) for n, p in decay_param_tp if "clipmodel." in n]
    decay_noclip_param_tp = [(n, p) for n, p in decay_param_tp if "clipmodel." not in n]

    no_decay_clip_param_tp = [(n, p) for n, p in no_decay_param_tp if "clipmodel." in n]
    no_decay_noclip_param_tp = [(n, p) for n, p in no_decay_param_tp if "clipmodel." not in n]
    ...
    optimizer_grouped_parameters = [
        ...
        {'params': [p for n, p in param_top
         ...
         'lr': lr_mul*learning_rate,
         'weight_decay': 0.0},
        {'params': [p for n, p in decay_clip_param_tp], 'weight_decay': weight_decay},
        {'params': [p for n, p in decay_noclip_param_tp], 'weight_decay': weight_decay, 'lr': tp_learning_rate},
        {'params': [p for n, p in no_decay_clip_param_tp], 'weight_decay': 0.0},
        {'params': [p for n, p in no_decay_noclip_param_tp], 'weight_decay': 0.0, 'lr': tp_learning_rate}
        ]
